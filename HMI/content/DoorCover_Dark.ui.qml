...
Item {
    ...
    Image {
        ...
        source: "images/MenuView/DoorCover/DarkTheme/Car.png"
        ...
        Item {
            ...
            Image {
                ...
                x: 0
                y: 0
                source: "images/MenuView/DoorCover/DarkTheme/LeftRear_Close.png"
                fillMode: Image.PreserveAspectFit
            }
            ...
            Image {
                ...
                x: 0
                y: 0
                source: "images/MenuView/DoorCover/DarkTheme/LeftFront_Close.png"
                fillMode: Image.PreserveAspectFit
            }
            ...
            Image {
                ...
                x: 0
                y: 0
                source: "images/MenuView/DoorCover/DarkTheme/RightFront_Close.png"
                fillMode: Image.PreserveAspectFit
            }
            ...
            Image {
                ...
                x: 0
                y: 0
                source: "images/MenuView/DoorCover/DarkTheme/RightRear_Close.png"
                fillMode: Image.PreserveAspectFit
            }
        }
        Item {
