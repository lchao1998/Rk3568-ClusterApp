...
Item {
    ...
    Image {
        ...
        source: "images/MenuView/DoorCover_OFF/LightTheme/Car.png"
        ...
        Item {
            ...
            Image {
                ...
                x: 0
                y: 0
                source: "images/MenuView/DoorCover_OFF/LightTheme/Close_LR.png"
                fillMode: Image.PreserveAspectFit
            }
            ...
            Image {
                ...
                x: 0
                y: 0
                source: "images/MenuView/DoorCover_OFF/LightTheme/Close_LF.png"
                fillMode: Image.PreserveAspectFit
            }
            ...
            Image {
                ...
                x: 0
                y: 0
                source: "images/MenuView/DoorCover_OFF/LightTheme/Close_RF.png"
                fillMode: Image.PreserveAspectFit
            }
            ...
            Image {
                ...
                x: 0
                y: 0
                source: "images/MenuView/DoorCover_OFF/LightTheme/Close_RR.png"
                fillMode: Image.PreserveAspectFit
            }
        }
        Item {
