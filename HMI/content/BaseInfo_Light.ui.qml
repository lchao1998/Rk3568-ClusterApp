...
Item {
    ...
    Item {
        ...
        Image {
            id: gear_Bg
            anchors.verticalCenter: parent.verticalCenter
            source: "images/BaseInfo/LightTheme/Gear_Bg.png"
            anchors.horizontalCenter: parent.horizontalCenter
        ...
        Row {
            ...
            Item {
                ...
                Image {
                    ...
                    source: "images/BaseInfo/LightTheme/oil_nor.png"
                    fillMode: Image.PreserveAspectFit
                }
                Image {
                    id: oil_low
        ...
        Row {
            ...
            Item {
                ...
                Image {
                    ...
                    source: "images/BaseInfo/LightTheme/WaterTemperature_Normal.png"
                    fillMode: Image.PreserveAspectFit
                }
                Image {
    ...
    Item {
        ...
        Row {
            ...
            Image {
                ...
                source: "images/BaseInfo/LightTheme/Energy_Recovery_Icon.png"
                fillMode: Image.PreserveAspectFit
            }
        ...
        Row {
            ...
            Image {
                ...
                Image {
                    ...
                    height: 24
                    source: "images/BaseInfo/Endurance_Power_Fg.png"
