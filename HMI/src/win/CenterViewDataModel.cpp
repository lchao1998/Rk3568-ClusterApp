...
DATA_PROPERTY_IMPLEMENT(CenterViewDataModel, Menu_SwSta, int)
{
    return m_menu_SwSta;
}

DATA_PROPERTY_IMPLEMENT(CenterViewDataModel, BMSErrorCodes, int)
{
