...
DATA_PROPERTY_EASY_IMPLEMENT(TelltaleDataModel, leftTurnlamp, bool)
DATA_PROPERTY_EASY_IMPLEMENT(TelltaleDataModel, rightTurnlamp, bool)
...
DATA_PROPERTY_EASY_IMPLEMENT(TelltaleDataModel, hazardIsSignaling, bool)
